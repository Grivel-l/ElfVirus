...
const char  instructions[][MAX_INS_SIZE] __attribute__ ((section (".text#"))) = {
  ...
  "\x02",
  "\x48\x83\x06\x05\x02\x00\x00\x05\x00\x02\x00\x00\xe8\x00\x02\x00\x00\x10\x00\x02", // SUB r64, imm8
  "\x48\x83\x06\x05\x02\x00\x00\x04\x00\x02\x00\x00\xc0\x00\x02\x00\x00\x10\x00\x02", // ADD r64, -imm8
  "\x02"
};
